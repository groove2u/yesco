...
public class CellphoneRoutingCheck {
    ...
    public static boolean checkSuperUser(){
        Log.d(CellphoneRoutingCheck.class.getSimpleName(), "디바이스 루팅 체크 =========");
    ...
    private static boolean checkRootedFiles(){
        ...
        for(int i = 0; i<files.length; i++){
            ...
            if(null != file && file.exists()){
                Log.d(CellphoneRoutingCheck.class.getSimpleName(),"Rooted File : " + file.getAbsolutePath() + " : " + file.getName());
                return true;
            }
        }
        return false;
    ...
    */
    private static boolean checkTags() {
        ...
        Log.d("FROCS", "========== test-keys : " + buildTags.contains("test-keys"));
    ...
    private static boolean checkSuperUserCommand(){
        try {
            ...
            Log.d(CellphoneRoutingCheck.class.getSimpleName(), "device has super user");
            return true;
        } catch (Error e){
